...
class MetaCoin extends _i1.GeneratedContract {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<String> getSymbol({_i1.BlockNum? atBlock}) async {
    final function = self.abi.functions[3];
    assert(checkSignature(function, '15070401'));
    final params = [];
    final response = await read(
      function,
      params,
  ...
  Future<String> sendCoin(
    ({_i1.EthereumAddress receiver, BigInt amount}) args, {
